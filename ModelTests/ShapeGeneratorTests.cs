...
namespace ModelTests
{
    ...
    {
        [Test(Description =
            "GetRandomCircle возвращает Circle с положительным радиусом")]
        ...
        [Test(Description =
            "GetRandomRectangle возвращает Rectangle " +
            "с положительными сторонами")]
        ...
        [Test(Description =
            "GetRandomTriangle возвращает Triangle с валидными сторонами")]
        ...
        [Test(Description =
            "GetRandomShape возвращает ShapeBase (одну из трёх фигур)")]
        public void GetRandomShapeReturnsShapeBase()
        {
            ...
            Assert.IsTrue(hasCircle,
                "GetRandomShape никогда не вернул Circle");
            Assert.IsTrue(hasRectangle,
                "GetRandomShape никогда не вернул Rectangle");
            Assert.IsTrue(hasTriangle,
                "GetRandomShape никогда не вернул Triangle");
        }

        [Test(Description =
            "GetRandomShape возвращает фигуру с положительной площадью")]
