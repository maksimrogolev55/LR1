...
namespace ModelTests
{
    ...
    {
        [Test(Description =
            "ShapeBase.Validate() вызывается без исключений через Circle")]
        ...
        [Test(Description =
            "Конструктор по умолчанию создаёт Circle без исключений")]
        ...
        [Test(Description =
            "Validate на корректном Circle не выбрасывает исключений")]
        ...
        [TestCase(3.0, 5.0,
            TestName = "Установка Radius через свойство на 5.0")]
        [TestCase(1.0, 2.5,
            TestName = "Установка Radius через свойство на 2.5")]
        public void SettingRadiusSetsCorrectValue(
            double initial, double newRadius)
        {
        ...
        [TestCase(1.0, Math.PI * 1.0 * 1.0,
            TestName = "CalculateArea для радиуса 1.0")]
        [TestCase(5.0, Math.PI * 5.0 * 5.0,
            TestName = "CalculateArea для радиуса 5.0")]
        [TestCase(2.5, Math.PI * 2.5 * 2.5,
            TestName = "CalculateArea для радиуса 2.5")]
        ...
        [TestCase(3.0,
            TestName = "GetInfo содержит радиус и площадь для радиуса 3.0")]
        [TestCase(7.5,
            TestName = "GetInfo содержит радиус и площадь для радиуса 7.5")]
        public void GetInfoContainsRadiusAndArea(double radius)
        {
            ...
            Assert.IsTrue(
                info.Contains(circle.CalculateArea().ToString("F2")));
        }
        ...
        [TestCase(-1.0,
            TestName = "Создание Circle с радиусом -1.0")]
        [TestCase(0.0,
            TestName = "Создание Circle с радиусом 0.0")]
        [TestCase(double.NaN,
            TestName = "Создание Circle с радиусом NaN")]
        [TestCase(double.PositiveInfinity,
            TestName = "Создание Circle с радиусом +Infinity")]
        [TestCase(double.NegativeInfinity,
            TestName = "Создание Circle с радиусом -Infinity")]
        public void ConstructorWithInvalidRadiusThrowsArgumentException(
        ...
        [TestCase(-1.0,
            TestName = "Validate с радиусом -1.0")]
        [TestCase(0.0,
            TestName = "Validate с радиусом 0.0")]
        [TestCase(double.NaN,
            TestName = "Validate с радиусом NaN")]
        [TestCase(double.PositiveInfinity,
            TestName = "Validate с радиусом +Infinity")]
        [TestCase(double.NegativeInfinity,
            TestName = "Validate с радиусом -Infinity")]
        public void ValidateWithInvalidRadiusThrowsArgumentException(
            double invalidRadius)
        {
